...
const FertilizerProductsScreen = ({ onBack }) => {
  ...
  const fertilizerProducts = useMemo(() => [
    ...
    },
    {
      ...
      price: 'UGX 366,000 (25kg)', packaging: '25kg: UGX 366,000',
    ...
    { id: 3, name: 'Magnesium Nitrate - Hexahydrate', imageId: 'fertilizer_3', category: 'Water Soluble', manufacturer: 'Uganda Crop Care Limited', price: 'UGX 158,800 (25kg)', description: 'Recommended for vegetative growth and during production stages.' },
    { id: 4, name: 'Elfert F - Trace Element Mix', imageId: 'fertilizer_4', category: 'Trace Elements', manufacturer: 'Uganda Crop Care Limited', price: 'UGX 779,600 (25kg)', description: 'Effective foliar spray to correct trace element deficiency.' },
    { id: 5, name: 'Nova Peak 0-52-34 - Monopotassium Phosphate', imageId: 'fertilizer_5', category: 'Water Soluble', manufacturer: 'Uganda Crop Care Limited', price: 'UGX 315,500 (25kg)', description: 'High purity product that dissolves completely and quickly in water.' },
    { id: 6, name: 'Calcium Nitrate - Nitrogen Calcium Compound', imageId: 'fertilizer_6', category: 'Water Soluble', manufacturer: 'Uganda Crop Care Limited', price: 'UGX 170,400 (25kg)', description: 'Helps with cell formation and neutralizes acids to detoxify plants.' },
    { id: 7, name: 'Yaravita Crop Boost', imageId: 'fertilizer_7', price: 'UGX 40,000 (1L)', description: 'Concentrated phosphorous foliar fertilizer for enhanced crop growth' },
    ...
    { id: 12, name: 'Yara Mila 25.5.5+5S', imageId: 'fertilizer_12', price: 'UGX 145,000 (50kg)', description: 'Yara Mila NPK with sulfur' },
    ...
    { id: 27, name: 'Yaravita Crop Boost', imageId: 'fertilizer_27', price: 'UGX 40,000 (1L)', description: 'Yaravita crop boost fertilizer' },
    ...
    { id: 32, name: 'NPK 2555+5S', imageId: 'fertilizer_32', price: 'UGX 160,000 (50kg)', description: 'High phosphorus NPK with sulfur' },
    ...
    { id: 38, name: 'Nutriplant Organic Plus', imageId: 'fertilizer_38', price: 'UGX 117,150 (1L) | UGX 15,000 (100ml)', description: 'Organic eliciting fertilizer' },
    { id: 39, name: 'Easygro Calcium', imageId: 'fertilizer_39', price: 'UGX 18,000 (1kg) | UGX 9,600 (500g) | UGX 6,400 (250g)', description: 'Water-soluble calcium fertilizer' },
    ...
    { id: 46, name: 'Mea-urea', imageId: 'fertilizer_46', price: 'UGX 140,000 (50kg)', description: 'MEA-urea fertilizer blend' },
