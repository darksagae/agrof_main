...
const SeedsProductsScreen = ({ onBack }) => {
  ...
  // Memoized products data - using the generated products
  const seedProducts = useMemo(() => [
    ...
    // Note: This is a simplified version with 10 products for demonstration
    // The full version would include all 72 products from the generated file
  ], []);
