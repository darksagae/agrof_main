...
const FertilizerProductsScreen = ({ onBack }) => {
  ...
  console.log('🏪 FertilizerProductsScreen: Rendering with optimized performance');
  
  // Static image imports for Expo compatibility
  const fertilizerImages = useMemo(() => ({
  ...
  const fertilizerProducts = useMemo(() => [
    {
      id: 1, name: 'Agri Gold Foliar Fertilizer', image: fertilizerImages.fertilizer_1,
      price: 'UGX 30,000 (1L) | UGX 15,000 (500ml)',
      description: 'Agri Gold is a wonder product that prevents flower shedding, promotes more flower formation and bumper yield.',
    },
    {
      id: 2, name: 'Omni K - Potassium Nitrate', image: fertilizerImages.fertilizer_2,
      price: 'UGX 366,000 (Retail) | UGX 357,500 (Wholesale)',
      description: 'Water-soluble fertilizer for fertigation or foliar application, supplying nitrate, nitrogen and chlorine free potassium to plants for enhanced growth and higher yields.',
    },
    {
      id: 3, name: 'Magnesium Nitrate - Hexahydrate', image: fertilizerImages.fertilizer_3,
      price: 'UGX 158,800',
      description: 'Recommended for vegetative growth and during production stages. High level of Magnesium contributes to chlorophyll production. Nitrogen has positive effect on Magnesium uptake in plants.',
    },
    {
      id: 4, name: 'Elfert F - Trace Element Mix', image: fertilizerImages.fertilizer_4,
      price: 'UGX 779,600',
      description: 'Effective foliar spray to correct trace element deficiency. Provides all required trace elements to boost yields. Essential for balancing uptake of major nutrients.',
    },
    {
      id: 5, name: 'Nova Peak 0-52-34 - Monopotassium Phosphate', image: fertilizerImages.fertilizer_5,
      price: 'UGX 315,500',
      description: 'High purity product that dissolves completely and quickly in water. Very low sodium content makes it suitable for any crop and fertigation system.',
    },
    {
      id: 6, name: 'Calcium Nitrate - Nitrogen Calcium Compound', image: fertilizerImages.fertilizer_6,
      price: 'UGX 170,400',
      description: 'Helps with cell formation and neutralizes acids to detoxify plants. Nitrogen component fuels protein production and leafy growth. Prevents blossom end rot in tomatoes.',
    },
  ...
  // Optimized product rendering with memoization and error handling
  const renderProduct = useCallback(({ item: product }) => {
    const isLoading = imageLoadingStates[product.id];
