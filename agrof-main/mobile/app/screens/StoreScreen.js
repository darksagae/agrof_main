        ...
        <View style={styles.searchResultsContainer}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <Image 
                  source={item.image_url ? { uri: `http://192.168.0.105:3001${item.image_url}` } : getCategoryImage(item.category_name)} 
        ...
        <View style={styles.featuredContainer}>
          ...
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.featuredScroll}>
            {featuredProducts.map((product) => (
              ...
              >
                <Image 
                  source={product.image_url ? { uri: `http://192.168.0.105:3001${product.image_url}` } : getCategoryImage(product.category_name)} 
