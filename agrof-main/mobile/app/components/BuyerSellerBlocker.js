 ...
 * 
 * This component demonstrates how to access real user data (fetched from Firebase/Cloudinary)
  ...
  return (
    <View style={styles.container}>
      <View style={styles.profileCard}>
        {/* Profile Photo - From Cloudinary or Base64 */}
        ...
        {/* User Information - Fetched from Firebase/Cloudinary */}
        ...
        <View style={styles.persistenceInfo}>
          ...
          <Text style={styles.persistenceText}>
            Data synced from Cloudinary & Firebase
          </Text>
        </View>
        <View style={styles.persistenceInfo}>
