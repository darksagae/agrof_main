...
# Script to replace the fungicideProducts array with the correct one
echo "=== REPLACING FUNGICIDE PRODUCTS ARRAY ==="
...
echo "✅ New fungicideProducts array created"

# Replace the fungicideProducts array in the file
echo "🔄 Replacing fungicideProducts array in the screen file..."

# Use sed to replace the array (from line 101 to 911)
sed -i '101,911c\
'"$NEW_PRODUCTS_ARRAY" "$FUNGICIDE_SCREEN_FILE"

echo "✅ fungicideProducts array replaced successfully!"
